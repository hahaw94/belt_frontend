<template>
  <div class="camera-management">
    <!-- 操作工具栏 -->
    <div class="toolbar">
      <el-button type="primary" :icon="Plus" @click="showCreateDialog">新建相机</el-button>
      <el-button type="info" :icon="Refresh" @click="refreshCameras">刷新</el-button>
    ...
    >
      ...
      <el-table-column label="操作" width="160" fixed="right">
        <template #default="scope">
          <el-button type="text" size="small" @click="viewCamera(scope.row)">查看</el-button>
          <el-button type="text" size="small" @click="editCamera(scope.row)">编辑</el-button>
          <el-button 
            type="text" 
            size="small" 
